...
internal static class TextBoxClearButton
{
    private const string BUTTON_VISIBLE_STATE = "ButtonVisible";
    private const string BUTTON_COLLAPSED_STATE = "ButtonCollapsed";
    ...
    public static void SetHasText(TextBox textBox, bool value)
    {
    ...
    private static void UpdateVisualStates(FrameworkElement textBox, bool isDeleteButtonVisible)
    {
        VisualStateManager.GoToState(textBox, isDeleteButtonVisible ? BUTTON_VISIBLE_STATE : BUTTON_COLLAPSED_STATE, true);
    }
}