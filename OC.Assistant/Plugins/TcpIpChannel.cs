...
internal class TcpIpChannel : IPluginClient
{
    ...
    public Type ClientType => GetType();
    public double TimeScaling => AppControl.Instance.TimeScaling;
