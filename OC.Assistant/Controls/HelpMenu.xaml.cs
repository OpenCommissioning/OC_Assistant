...
internal partial class HelpMenu
{
    ...
    private void AboutOnClick(object sender, RoutedEventArgs e)
    {
        ...
        stack.Add(new DependencyInfo(typeof(Core.ControlBase)));
        stack.Add(new DependencyInfo(typeof(Generator.Control)));
        stack.Add(new DependencyInfo(typeof(PnGenerator.Control)));
